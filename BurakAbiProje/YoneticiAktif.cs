...
namespace BurakAbiProje
{
    public partial class YoneticiAktif : Form
    {
        ...
        {
            this.Close();
            YoneticiArayuz frm = new YoneticiArayuz();
            frm.Show();
        }

        private void YoneticiAktif_Load(object sender, EventArgs e)
        {
            DataTable dt = new DataTable();
            MySqlDataAdapter da = new MySqlDataAdapter("select * from aktifis", baglanti);
            da.Fill(dt);
